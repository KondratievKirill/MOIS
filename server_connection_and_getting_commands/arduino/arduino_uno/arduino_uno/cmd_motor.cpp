...
CmdResult handleMotor(JsonObject params) {
  int left_pwm = params["left_pwm"];
  int right_pwm = params["right_pwm"];
  
  const char* left_dir = params["left_dir"];
  const char* right_dir = params["right_dir"];
